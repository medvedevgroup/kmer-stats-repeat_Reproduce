...
def create_single_panel_boxplot(data):
    ...
    # Custom color palette - using the LaTeX notation for r_strong
    methods = [r'$\hat{r}$'] + [f'r_sketch (θ={theta})' for theta in theta_values]  # Changed from 'r_strong' to '$\hat{r}$'
    ...
    ax.set_xticklabels(tick_labels, rotation=45, fontsize=60)  # Increased tick font size
    ...
    ax.legend(handles, labels, fontsize=45, frameon=True, framealpha=0.9, loc='upper left')
